...
const ModalConnection = ({open, close}) => {
    const { connecterra, connectStargaze, connectJuno, connectPetra, connectMartian } = useTerra();
    ...
    return ( 
        <div className="fixed inset-0 w-full h-full bg-black/50  z-50  flex justify-center items-center opacity-100 transition-opacity duration-1000" aria-label="modal">
            ...
            <div className="bg-noir rounded relative flex flex-col  justify-center m-8 max-w-sm w-full p-6 opacity-100 ">
