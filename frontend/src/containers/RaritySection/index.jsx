        ...
        <section className=" m-10  ">
          <div className=" flex justify-between mx-10" aria-label="search fields ">
            <div  aria-label="search by name" className="max-w-md w-full flex items-center rounded-xl border-2 border-[#f4f6f9] focus:shadow focus:outline-none focus-visible:border-violet h-12  p-1 cursor-text ">
              ...
              <input type="text" placeholder="Enter the collection name you're searching for" 
            ...
            <div className="relative" aria-label="select blockchain filter">
              ...
              {show && <div ref={ref} className="absolute top-full z-50 min-w-[150px] bg-noir opacity-100 outline-none rounded-lg border-[1px] border-noir">
                <ul className="py-2">
                  <li aria-selected={true} className="py-2 px-6 hover:bg-[#212529] cursor-pointer select-none" value="All Chains">All Chains</li>
                  <hr aria-readonly={true} className="my-2" />
                  <li aria-selected={false} className="py-4 px-6 hover:bg-[#212529] cursor-pointer select-none" value="Terra">Terra</li>
                  <li aria-selected={false} className="py-4 px-6 hover:bg-[#212529] cursor-pointer select-none" value="Stargaze">Stargaze</li>
                  <li aria-selected={false} className="py-4 px-6 hover:bg-[#212529] cursor-pointer select-none" value="Juno">Juno</li>
                </ul>
              </div>}
            </div>
          </div>
